...
#define MyAppName "WSL USB Manager"
#define MyAppVersion ""
#define MyAppPublisher "Chuckie"
#define MyAppURL "https://github.com/zcj20080882/wsl-usb-manager"
#define MyAppExeName "wsl-usb-manager.exe"
...
[Files]
Source: "ReleasePublish\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
Source: "ReleasePublish\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
...
Type: filesandordirs; Name: "{userappdata}\WSL USB Manager"
